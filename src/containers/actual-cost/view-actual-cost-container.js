...
export default function ViewActualCostContainer() {
        ...
        <Card width="75%">
            <Card.InputColumn notResponsive center>
                ...
                <Card.ButtonGroup flexEnd>
                    <Button small onClick={() => navigate(`/actual-cost/${params.id}/update`, {state: { from: location }})}>Update Actual Cost</Button>
